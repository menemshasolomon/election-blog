...
Table: <span id="tab:unnamed-chunk-4"></span>Table 1: Mean Error in the Predictive Models According to Cross Validation

|Variable (Measured in Q2) | Mean Error| Standard Deviation of Error|
|:-------------------------|----------:|---------------------------:|
|GDP Growth                | -0.1853191|                    5.004388|
|RDPI Growth               |  0.0800003|                    5.812816|
